...
export const clientDBSlice: StateCreator<GlobalStore, [["zustand/devtools", never]], [], GlobalClientDBAction> = (
	set,
	get
) => ({
	...
	useInitClientDB: (params) => useOnlyFetchOnceSWR("initClientDB", () => get().initializeClientDB(params)),
});
