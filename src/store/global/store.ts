...
export interface GlobalStore extends GlobalState, GlobalWorkspacePaneAction, GlobalClientDBAction, GlobalGeneralAction {
	/* empty */
}
...
export const useGlobalStore = createWithEqualityFn<GlobalStore>()(subscribeWithSelector(createStore), shallow);
